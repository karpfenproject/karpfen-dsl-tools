...
public class KstatesLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"STATEMACHINE", "ATTACHED", "TO", "STATES", "STATE", "INITIAL", "ENTRY", 
			"DO", "SET", "APPEND", "EVENT", "MACRO", "EVAL", "TRANSITIONS", "TRANSITION", 
			"NOT", "LOOPING", "CONDITION", "VALUE", "MACROS", "TAKES", "RETURNS", 
			"DEFINITION", "REFERENCE", "IF", "IN", "SCOPE", "ARROW", "LBRACE", "RBRACE", 
			"LPAREN", "RPAREN", "COMMA", "STRING", "SSTRING", "IDENT", "NUMBER", 
			"WS", "LINE_COMMENT", "SYMBOL"
		};
	}
	...
	public KstatesLexer(CharStream input) {
		super(input);
